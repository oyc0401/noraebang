...
/**
 * 기기 ID로 익명 로그인하여 토큰 발급
 * @summary 익명 로그인
 */
export const authControllerAnonymousLogin = (
    anonymousLoginDto: AnonymousLoginDto,
 signal?: AbortSignal
) => {
...
export const getAuthControllerAnonymousLoginMutationOptions = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof authControllerAnonymousLogin>>, TError,{data: AnonymousLoginDto}, TContext>, }
): UseMutationOptions<Awaited<ReturnType<typeof authControllerAnonymousLogin>>, TError,{data: AnonymousLoginDto}, TContext> => {
...
const {mutation: mutationOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof authControllerAnonymousLogin>>, {data: AnonymousLoginDto}> = (props) => {
          const {data} = props ?? {};

          return  authControllerAnonymousLogin(data,)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type AuthControllerAnonymousLoginMutationBody = AnonymousLoginDto
