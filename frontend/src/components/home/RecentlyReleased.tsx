  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-3">
        <div className="flex items-center gap-4 bg-surface-light dark:bg-surface-dark p-3 rounded-xl shadow-sm ring-1 ring-black/5 dark:ring-white/5 active:scale-[0.98] transition-transform duration-200 cursor-pointer">
          <img
          ...
          <button
            type="button"
            className="size-8 flex items-center justify-center rounded-full bg-gray-100 dark:bg-white/10 text-gray-500 dark:text-gray-400 hover:text-primary dark:hover:text-primary transition-colors"
          >
