// Copy the entire contents of this file into the browser console and call saveTJPropose(params)
(function attachSaveTJProposeToWindow() {
  const cookie =
  ...
  async function saveTJPropose(params) {
  ...
  window.saveTJPropose = saveTJPropose;
  console.log("✅ saveTJPropose attached to window");
})();
